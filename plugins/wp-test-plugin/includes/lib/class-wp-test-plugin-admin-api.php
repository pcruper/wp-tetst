 ...
 * Admin API class.
 */
class WP_Test_Plugin_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'wp-test-plugin' ) . '" data-uploader_button_text="' . __( 'Use image', 'wp-test-plugin' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'wp-test-plugin' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'wp-test-plugin' ) . '" />' . "\n";
